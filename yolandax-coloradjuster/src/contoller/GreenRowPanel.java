    ...
    private void updateText() {
        if (myEnableEditButton.isSelected()) {
            if (myValueField.getText().matches("\\d+")
                ...
                myValueField.setText(Integer.toString(myColor.getGreen()));
            }
        } 
    }
